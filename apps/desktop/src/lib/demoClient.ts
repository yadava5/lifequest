...
const QUESTS: Quest[] = [
  ...
  },
  {
    ...
    description: 'Show up to one meetup and introduce yourself to two people.',
    audience: 'SHARED',
    type: 'COMMUNITY',
    reward: 100,
  },
  {
    id: 'quest-5',
    title: 'Thirty minutes of upskilling',
    description: 'One focused block on a skill your target roles ask for.',
    audience: 'SHARED',
    type: 'TASK',
    reward: 30,
  },
