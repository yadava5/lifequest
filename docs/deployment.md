...
This repo ships the API and desktop web build to managed hosting without changing local workflows. Deployments are triggered directly from Render and Vercel (no GitHub Actions deploy workflow).
